    ...
    def build(
        ...
        *,
        ...
        return MarketObservation(
            ...
            own_last_price=state.last_price,
            own_last_profit=state.last_profit,
            own_last_shortage=state.last_shortage,
            own_reputation=state.reputation,
            own_reputation_delivery=state.rep_delivery,
            own_reputation_pricing=state.rep_pricing,
            own_reputation_cooperation=state.rep_cooperation,
